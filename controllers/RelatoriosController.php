    ...
    // setup kartik\mpdf\Pdf component
        ...
        //$model = $this->findModel($id_evento);
            ...
            $pdf->WriteHTML(''); //se tirar isso, desaparece o cabeçalho
	            ...
	            $pdf->MultiCell(0,4,("Relatórios"),0, 'C');
        ...
        $model = User:: find()->select(['nome','email','COUNT(evento.responsavel) AS qtd_evento'])
        ...
        ->all();
		        ...
		        $inicio = '<table border="1" align = "center">
                        <tr>
                        <th width = "300px">Coordenador de Evento</th>
                        <th width = "300px">Quantidade de Eventos</th>
                        </tr>
                ';
