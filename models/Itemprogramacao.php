...
class Itemprogramacao extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['iditemProgramacao', 'titulo', 'descricao', 'palestrante', 'data', 'hora', 'vagas', 'cagaHoraria', 'notificacao', 'local_idlocal', 'evento_idevento', 'tipo_idtipo'], 'required', 'message'=>'Este campo é obrigatório'],
