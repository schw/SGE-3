...
$this->title = 'Quantidade de Eventos criados por Professor';
    ...
    <div class="container">
     <table class="table">
        <thead>
            <tr>
                <th>#</th>
                <th width = "200px">Coordenador de Evento</th>
                <th style= "text-align: center">Quantidade de Eventos</th>
            </tr>
        </thead>
    ...
    <?php 
        ...
        for ($i = 0; $i<$qtd_rows; $i++){
            ...
            echo '<tr>
                <td>'.($i+1).'</td>
                <td>'.$coordenador.'</td>
                <td style= "text-align: center">'.$qtd_evento.'</td>
                </tr>';
        }
            echo '</table></div>';
    }
